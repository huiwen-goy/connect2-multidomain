...
*Note that there hasn't yet been "cleaning" of any variables, e.g., for year of birth, some people typed in text other than four digits.*
...
# Read cleaned-up dataset, containing Qualtrics data matched to Connect data for those who consented to sharing clinic data (and those who had clinic data available)
...
Of 527 respondents, 439 have full audiograms available; 85 have completely missing audiograms, and 3 have between 2 and 6 missing cells.
```{r, echo=FALSE}
