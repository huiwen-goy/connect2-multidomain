...
Note: All those with unknown Group and all those with >10% missing data have been excluded for these plots.
```{r, echo=FALSE}
...
#Co-morbidities [,22:52]
# Types of health issues: vision, "physical", arthritis, neuro/cognitive, psychological

#1. cataracts - y
##table(data[, 22], useNA='always')
#2. other eye disorder, e.g., glaucoma or macular degeneration - y
##table(data[, 23], useNA='always')
#3. allergies
#table(data[, 24], useNA='always')
#4. asthma
#table(data[, 25], useNA='always')
#5. lung disorder, including emphysema, chronic bronchitis, chronic obstructive pulmonary disease, or #chronic changes in lungs due to smoking
#table(data[, 26], useNA='always')
#6. diabetes, borderline diabetes or high blood sugar - y
#table(data[, 27], useNA='always')
#7. under-active thyroid gland, sometimes called hypothyroidism or myxedema
#table(data[, 28], useNA='always')
#8. over-active thyroid gland, sometimes called hyperthyroidism or Graves’ disease
#table(data[, 29], useNA='always')
#9. cancer
#table(data[, 30], useNA='always')
#10. heart disease, including congestive heart failure, angina, heart attack or myocardial infarction - y
#table(data[, 31], useNA='always')
#11. peripheral vascular disease or poor circulation in your limbs
#table(data[, 32], useNA='always')
#12. high blood pressure or hypertension
#table(data[, 33], useNA='always')
#13. stroke or cerebrovascular accident (CVA), including mini-stroke or Transient Ischemic Attack (TIA)
#table(data[, 34], useNA='always')
#14. kidney disease
#table(data[, 35], useNA='always')
#15. urinary incontinence
#table(data[, 36], useNA='always')
#16. intestinal or stomach ulcers
#table(data[, 37], useNA='always')
#17. bowel disorder such as Crohn’s Disease, ulcerative colitis, or Irri#table Bowel Syndrome
#table(data[, 38], useNA='always')
#18. bowel incontinence
#table(data[, 39], useNA='always')
#19. osteoarthritis
#table(data[, 40], useNA='always')
#20. rheumatoid arthritis
#table(data[, 41], useNA='always')
#21. any other type of arthritis
#table(data[, 42], useNA='always')
#22. osteoporosis, also called low bone mineral density, or thin, brittle, or weak bones
#table(data[, 43], useNA='always')
#23. back problems, excluding fibromyalgia and arthritis
#table(data[, 44], useNA='always')
#24. memory problems
#table(data[, 45], useNA='always')
#25. dementia or Alzheimer’s disease
#table(data[, 46], useNA='always')
#26. Parkinsonism or Parkinson’s disease
#table(data[, 47], useNA='always')
#27. multiple sclerosis
#table(data[, 48], useNA='always')
#28. epilepsy
#table(data[, 49], useNA='always')
#29. migraine headaches
#table(data[, 50], useNA='always')
#30. anxiety disorder, including a phobia, obsessive-compulsive disorder or a panic disorder
#table(data[, 51], useNA='always')
#31. depression disorder, including manic depression, bipolar disorder, mania, or dysthymia
#table(data[, 52], useNA='always')
...
The same question on loneliness was asked in Connect 1 as in Connect 2: "In the past week, how often did you feel lonely? All of the time, Occasionally, Some of the time, Rarely or never."
 
```{r, echo=FALSE}

# How many people have that question at Time 1 and Time 2, and of those, how many people obtained HA?
...
### Loneliness, social support, HHIE subscales, SSQ

```{r, echo=FALSE}

#data$Group
#data$Lonely
#data$SocSuppMOS_overall
#data$SocSuppMOS_emoinfo
#data$SocSuppMOS_tangible
#data$SocSuppMOS_affection
#data$SocSuppMOS_positive
#data$HHIES_emo
#data$HHIES_soc
#data$SSQ15i_avg
